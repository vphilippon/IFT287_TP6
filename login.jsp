...
<BODY>
	<CENTER>
		...
		<FORM ACTION="Login" METHOD="POST">
			<BR> <BR> User Id : <INPUT TYPE="TEXT" NAME="userIdBD"
				VALUE="postgres"> <BR> <BR> Mot de passe : <INPUT
				TYPE="TEXT" NAME="motDePasseBD" VALUE="ubuntu"> <BR> <BR>
			Serveur : <SELECT NAME="serveur">
				<OPTION VALUE="postgres">postgres
			</SELECT> <BR> <BR> adresseIP : <INPUT TYPE="TEXT" NAME="adresseIP"
				VALUE="127.0.0.1"> <BR> <BR> BD : <INPUT
				TYPE="TEXT" NAME="bd" VALUE="postgres"> <BR> <BR>
