...
public class GestionFilm {
    ...
    public GestionFilm(Film film, Personne personne, RoleFilm roleFilm) throws Tp6Exception{
    ...
    public void ajoutFilm(String titre, Date dateSortie, String realisateur) throws Exception {
        try {
            ...
            if (film.existe(titre, dateSortie)) {
                throw new Tp6Exception("Impossible d'ajouter, le film " + titre + " paru le " + dateSortie + " existe deja.");
            }
            ...
            if (realisateurNaissance.after(dateSortie)){
                throw new Tp6Exception("Le réalisateur " + realisateur + " est né le: " + realisateurNaissance + 
    ...
    public void supprimerFilm(String titre, Date dateSortie) throws Exception {
        try {
            ...
            if (!film.existe(titre, dateSortie)) {
                throw new Tp6Exception("Impossible de supprimer, le film " + titre + " paru le " + dateSortie + " n'existe pas.");
            }
            //Verifie si un role est relier au film
            if(roleFilm.aDesRoles(titre, dateSortie)){
                throw new Tp6Exception("Impossible de supprimer, le film " + titre + ", un/des role(s) y sont encore rattache.");
            }
    ...
    public void ajoutDescFilm(String titre, Date anneeSortie, String description, int duree) throws Exception {
        try{
            ...
            if(!film.existe(titre, anneeSortie)){
                throw new Tp6Exception("Impossible d'ajouter la description, le film " + titre + " paru le " + anneeSortie + " n'existe pas.");
            }
    ...
    public void ajoutActeurFilm(String titre, Date anneeSortie, String nomActeur, String role) throws Exception {
        try {
            ...
            if (!personne.existe(nomActeur)) {
                throw new Tp6Exception("Impossible d'ajouter l'acteur au film, l'acteur " + nomActeur + " n'existe pas.");
            }
            
            //verifie si le film existe
            if (!film.existe(titre, anneeSortie)) {
                throw new Tp6Exception("Impossible d'ajouter l'acteur au film, le film " + titre + " paru le " + anneeSortie + " n'existe pas.");
            }
            ...
            if(acteur.getDateNaissance().after(anneeSortie)){
                throw new Tp6Exception("Impossible d'ajouter l'acteur au film, l'acteur " + nomActeur + " est nee avant la date de sortie du film.");
            }
    ...
    public void afficherActeurDeFilm(String titre, Date anneeSortie) throws Tp6Exception, SQLException {
        if(!film.existe(titre, anneeSortie)){
            throw new Tp6Exception("Le film " + titre + " paru en " + anneeSortie + " n'existe pas.");
        }
